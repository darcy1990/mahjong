	...
	<view class="container">
		<view>
			<div class="flex-container">
			  ...
			  <div class="flex-item middle" style="width: 40%;"><uni-data-select>金之间</uni-data-select></div>
			</div>		
		</view>
		<view>
			<div class="flex-container">
			  <div class="flex-item" style="width: 12%;">日期：</div>
			  <div class="flex-item middle" style="width: 80%;"><uni-datetime-picker></uni-datetime-picker>~<uni-datetime-picker></uni-datetime-picker></div>
			</div>		
		</view>
		...
		<view>
			<text>牌搭子</text>
			<text class="left green">离开房间</text>
		</view>
		...
		<view style="margin: 10px">
			<view>上拉加载更多...</view>
			<view>
				<image src="../../static/head.png" class="im2"></image> <text class="left green">下午一点可以吗？</text>
			</view>
			<view>
				<image src="../../static/head.png" class="im2"></image> <text class="left green">下午一点可以吗？</text>
			</view>
		...
		<view style="margin-top: 15px;">
			<div class="flex-container">
			   <div class="flex-item" style="width: 60%;"><input class="uni-input" maxlength="30" placeholder="最大输入长度为10" /> </div>
			   <div class="flex-item" style="width: 20%;"><button>发送</button></div>
			</div>
		</view>
	</view>
</template>
